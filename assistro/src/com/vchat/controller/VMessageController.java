...
import com.vchat.service.MessageQueue;
import com.vchat.service.Visitor;
...
public class VMessageController{
	...
	private final HashMap<String, MessageQueue> tempchatqueue = new HashMap<String, MessageQueue>();
	...
	public synchronized int sessionCount(String widgetKey) {
		int i = 0;
		try {
			Iterator<Entry<String, MessageQueue>> iterator = tempchatqueue
					.entrySet().iterator();
