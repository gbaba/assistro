...
<head> 
	...
	<script type="text/javascript" charset="utf-8"> 
		...
		function load() {
			new Cropper.ImgWithPreview( 'picture', { previewWrap: 'preview', minWidth:53, minHeight:53, ratioDim: {x:53, y:53}, displayOnInit: true, onEndCrop: onEndCrop } );
		}
 
		function submitProcess() {
		  	document.getElementById('formContent').style.display = 'none';
		  	document.getElementById('waitContent').style.display = 'block';
		  	<%-- window.location.href = 'process.jsp?myurl=' + <%=request.getParameter("key")%> +'&x1=' + x1 + '&y1=' + y1 + '&x2=' + x2 + '&y2=' + y2 + '&iw=' + iw + '&ih=' + ih ;
		 --%>
		}
...
<body> 
	...
	<div id="formContent"> 
		<div style="height:250px;">
			<center>
				<img src="<%=request.getParameter("croppedImg")%>" alt="Select the area you want to keep" id="picture" style="border:none;" />
			</center>
		</div> 
		...
		<div>
			<div style="float:left;"><b>Chat Image</b></div>
			<div style="margin-left:10px;margin-right:10px;float:left;">
				<div id="preview" style="border:solid 1px black;"></div> 
		 	</div>
			<span>
				To make adjustments to your thumbnail image, drag and resize the dotted lines in your profile photo above.
			</span>
		</div>
	...
	<div id="waitContent" style="display:none;">
		...
		<center>
			<img src="/img/wbg/loading.gif" alt="uploading..." />
		</center>
		<br /><br />
	</div>
