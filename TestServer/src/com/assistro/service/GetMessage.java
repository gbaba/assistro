...
//			if(VMessageController.getVMessageController().lastMessageId(widgetId)-lastId >= 2 && lastId !=0){
//				//lastId = VMessageController.getVMessageController().lastMessageId(widgetId)-1;
//				lastId=0;
//			}
